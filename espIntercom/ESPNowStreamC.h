...
//USing custom esp now since the retry had a bug where the retries were increased before dećreased
//esp now has a bug for one to many tx if you do not have static buffers for wifi

namespace audio_tools {

// forward declarations
class ESPNowStreamC;
static ESPNowStreamC *ESPNowStreamSelf = nullptr;
 ...
 * @copyright GPLv3
 */
class ESPNowStreamC : public BaseStream {
 public:
  ESPNowStreamC() { ESPNowStreamSelf = this; };
